<header class="main-header">
    <div class="container max-w-full ">
        <div class="bg-bg-gray h-12">
            <div class="container mx-auto sm:px-6 flex py-2 header-global-container">
                <img src="{{ mix('assets/images/code4ro_head.png') }}">
                <div class="ml-3 self-center text-sm font-medium">
                ...
                <div class="header-right" id="sideNav">
                    <div class="header-list">
                        ...
                        @foreach ($pages as $page)
                            ...
                            @endif
                        @endforeach
                        <a href="https://code4.ro/en/donate/" class="text-green-500"> {{ __('txt.buttons.donate') }} </a>
